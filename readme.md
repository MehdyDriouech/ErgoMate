...
Le code source de **Ergo Mate** est distribué sous licence **AGPL 3.0**.
...
📜 **Texte complet** : [GNU AFFERO GENERAL PUBLIC LICENSE Version 3]([https://creativecommons.org/licenses/by-nc/4.0/](https://www.gnu.org/licenses/agpl-3.0.txt))
